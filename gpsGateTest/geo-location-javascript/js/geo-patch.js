...
var geo_position_js=function() {
        ...
        {			
                try
                {
                        ...
                        else if (typeof(GpsGate) != 'undefined' && typeof(GpsGate.Client) != 'undefined')
                        {
                                ...
                                pub.getCurrentPosition = function(successCallback,errorCallback,options)
                                {
                                        GpsGate.Client.getGpsInfo(function(gps){
                                            ...
                                            if (gps.status.valid)
                                            {
                                                p = {coords:{longitude:gps.trackPoint.position.longitude,
                                                ...
                                                p = {message:'Can not receive location from GPSGate'};
                                                errorCallback(p);
                                            }
                                        });
                                }
